...
const toggleBookRequestForm = document.getElementById('toggle-book-request-form');
...
function btnToggleBookRequestForm() {
	if (toggeleBGDisabler.style.visibility == "visible") {
		toggleBookRequestForm.classList.toggle('active');
		toggeleBGDisabler.style.visibility = "hidden";
	} else {
		toggeleBGDisabler.style.visibility = "visible";
		toggleBookRequestForm.style.visibility = "visible";
		setTimeout(() => toggleBookRequestForm.classList.toggle('active'), 300); 
	}
} 
